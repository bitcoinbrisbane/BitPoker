namespace BitPoker.Logic.Helpers
{
    ...
    {
        internal BestHand(Models.HandRankType rankType, ICollection<CardType> cards)
        {
            if (cards.Count != 5)
            {
        ...
        public Models.HandRankType RankType { get; }
