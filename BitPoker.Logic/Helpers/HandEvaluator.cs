    ...
    public class HandEvaluator : IHandEvaluator
    {
        ...
        public BestHand GetBestHand(IEnumerable<Card> cards)
        {
            ...
            if (cardSuitCounts.Any(x => x >= ComparableCards))
            {
                ...
                {
                    return new BestHand(Models.HandRankType.StraightFlush, straightFlushCards);
                }
                    ...
                    if (cardSuitCounts[i] >= ComparableCards)
                    {
                        var flushCards =
                            cards.Where(x => x.Suit == (CardSuit)i)
                                ...
                                .ToList();
                        return new BestHand(Models.HandRankType.Flush, flushCards);
                    }
                }
            }
            ...
            if (cardTypeCounts.Any(x => x == 4))
            {
                ...
                return new BestHand(Models.HandRankType.FourOfAKind, bestCards);
            }
            ...
            if ((pairTypes.Count > 0 && threeOfAKindTypes.Count > 0) || threeOfAKindTypes.Count > 1)
            {
                ...
                return new BestHand(Models.HandRankType.FullHouse, bestCards);
            }
            ...
            {
                return new BestHand(Models.HandRankType.Straight, straightCards);
            }
            ...
            if (threeOfAKindTypes.Count > 0)
            {
                ...
                return new BestHand(Models.HandRankType.ThreeOfAKind, bestCards);
            }
            ...
            if (pairTypes.Count >= 2)
            {
                ...
                return new BestHand(Models.HandRankType.TwoPairs, bestCards);
            }
            ...
            if (pairTypes.Count == 1)
            {
                ...
                return new BestHand(Models.HandRankType.Pair, bestCards);
            }
            else
            {
                // High card
                ...
                return new BestHand(Models.HandRankType.HighCard, bestCards);
            }
        }
